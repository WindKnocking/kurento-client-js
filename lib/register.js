var checkType = require('./checkType');
    var kurento-client-core = require('./kurento-client-core');
    var kurento-client-elements = require('./kurento-client-elements');
    var kurento-client-filters = require('./kurento-client-filters');
...
// Execute require if we only have a name
        ...
        {
            return register(kurento-client-core);
        }
            if(name=='kurento-client-elements')
            {
                return register(kurento-client-elements);
            }
            if(name=='kurento-client-filters')
            {
                return register(kurento-client-filters);
            }
