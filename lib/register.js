var checkType = require('./checkType');
    ...
    var kurentoClientElements = require('kurento-client-elements');
    var kurentoClientFilters = require('kurento-client-filters');
...
// Execute require if we only have a name
        ...
        {if(name=='kurento-client-core')
        {
            return register(kurentoClientCore);
        }
            if(name=='kurento-client-elements')
            {
                return register(kurentoClientElements);
            }
            if(name=='kurento-client-filters')
            {
                return register(kurentoClientFilters);
            }
...
// Execute require if the constructor is set as a string
        ...
        {
            if(constructor=='kurento-client-core')
        {
            return register(name,kurentoClientCore);
        }
            if(constructor=='kurento-client-elements')
            {
                return register(name,kurentoClientElements);
            }
            if(constructor=='kurento-client-filters')
            {
                return register(name,kurentoClientFilters);
            }
        }
